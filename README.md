...
Statistics of redundant records in the KDD train set		Statistics of redundant records in the KDD test set
...
The distribution of #successfulPrediction values for the
                                KDD train set records		The distribution of #successfulPrediction values for the
                                KDD test set records
The distribution of #successfulPrediction values for
the KDD train set records		The distribution of #successfulPrediction values for
the KDD test set records
Refrences
